...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.addCar(new Car("Car 1", 111));
      userService.addCar(new Car("Car 2", 222));
      userService.addCar(new Car("Car 3", 333));
      userService.addCar(new Car("Car 4", 444));
      ...
      System.out.println(userService.getUserByCar("Car 3", 333));
